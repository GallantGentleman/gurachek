      ...
      <div class="col-xs-6 col-lg-4">
          <div class="thumbnail" style="height:200px;">
                <div class="caption" stype="margin-left: 50px;">
                  <a style='color: #dc815b;' href="<?=SITE_NAME;?>project/?id=<?=$data[$i]['id'];?>">
                    <img style='float:left' src="<?=SITE_NAME;?>src/img/project_icon/<?=$data[$i]['img'];?>.png">
                  </a>
                    <h3 align='center' style='margin-left:80px;'>
                         <a style='color: #dc815b;' href="<?=SITE_NAME;?>project/?id=<?=$data[$i]['id'];?>"><?=$data[$i]['name'];?></a>
                    </h3>
                    <p style="padding-left: 10px;float:;margin-left: 80px;"><?=$data[$i]['desc_p'];?></p>
                </div>
          </div>
      </div>
    <?php } ?>
